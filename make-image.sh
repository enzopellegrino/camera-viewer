...
# Produce dist/camera-viewer-v2.7.img.xz da distribuire ai clienti.
#
# Workflow:
...
# Tempo: ~15-20 min
# Output: dist/camera-viewer-v2.7.img.xz (~3-4GB)
# USB minima: 16GB
# =============================================================================
set -euo pipefail
...
menuentry "  Installa Camera Viewer v2.7 su disco interno" {
